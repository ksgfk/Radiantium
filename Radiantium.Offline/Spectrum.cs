...
namespace Radiantium.Offline
{
    ...
    {
        public static IReadOnlyDictionary<string, (Color3F, Color3F)> NameToEtaAndK => _nameToEtaK;

        public static Color3F XyzToRgb(Vector3 xyz)
        {
            Color3F rgb;
        ...
        public static Color3F FromSampled(float[] lambda, float[] v)
        {
            if (!SpectrumSamplesSorted(lambda, v))
            {
                SortSpectrumSamples(lambda, v);
            }
            Vector3 xyz = new Vector3(0.0f);
            for (int i = 0; i < CIESamples; ++i)
            {
            ...
            float scale = (CIE_lambda[CIESamples - 1] - CIE_lambda[0]) / (CIE_Y_integral * CIESamples);
            xyz *= scale;
            return XyzToRgb(xyz);
        }

        public static bool TryGetMatel(string name, out (Color3F, Color3F) etaK)
        {
            return _nameToEtaK.TryGetValue(name, out etaK);
        }

        #region MetalData
        private const int CIESamples = 471;
        private const float CIE_Y_integral = 106.856895f;
        private static Dictionary<string, (Color3F, Color3F)> _nameToEtaK = new()
        {
            { "a-C", (new(2.9378555f, 2.2224224f, 1.9639966f), new(0.8855466f, 0.7976256f, 0.8135586f)) },
            { "a-C_palik", (new(2.9378555f, 2.2224224f, 1.9639966f), new(0.8855466f, 0.7976256f, 0.8135586f)) },
            { "a-SiH", (new(5.5911508f, 4.7782454f, 4.8923211f), new(0.2277372f, 0.6178421f, 1.6055330f)) },
            { "a-SiH_palik", (new(5.5911508f, 4.7782454f, 4.8923211f), new(0.2277372f, 0.6178421f, 1.6055330f)) },
            { "Ag", (new(0.1549343f, 0.1164734f, 0.1380863f), new(4.8180990f, 3.1156154f, 2.1424003f)) },
            { "Al", (new(1.6539409f, 0.8784990f, 0.5201210f), new(9.2043056f, 6.2562046f, 4.8267488f)) },
            { "AlAs", (new(3.5973687f, 3.2261393f, 2.2123513f), new(0.0006653f, -0.0005011f, 0.0074097f)) },
            { "AlAs_palik", (new(3.5973687f, 3.2261393f, 2.2123513f), new(0.0006653f, -0.0005011f, 0.0074097f)) },
            { "AlSb", (new(4.7083006f, 4.0519624f, 4.5741849f), new(-0.0291775f, 0.0934454f, 1.2978398f)) },
            { "AlSb_palik", (new(4.7083006f, 4.0519624f, 4.5741849f), new(-0.0291775f, 0.0934454f, 1.2978398f)) },
            { "Au", (new(0.1428174f, 0.3741433f, 1.4394432f), new(3.9747169f, 2.3806596f, 1.5998082f)) },
            { "Be", (new(4.1761742f, 3.1783011f, 2.7781928f), new(3.8272955f, 3.0037363f, 2.8629277f)) },
            { "Be_palik", (new(4.1761742f, 3.1783011f, 2.7781928f), new(3.8272955f, 3.0037363f, 2.8629277f)) },
            { "Cr", (new(4.3604083f, 2.9105196f, 1.6511863f), new(5.1953816f, 4.2223840f, 3.7469974f)) },
            { "CsI", (new(2.1403484f, 1.6987029f, 1.6588967f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "CsI_palik", (new(2.1403484f, 1.6987029f, 1.6588967f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "Cu", (new(0.1999899f, 0.9220823f, 1.0998751f), new(3.9046354f, 2.4476316f, 2.1376500f)) },
            { "Cu2O", (new(3.5442462f, 2.9436538f, 2.7461953f), new(0.1139511f, 0.1934149f, 0.6047450f)) },
            { "Cu2O_palik", (new(3.5442462f, 2.9436538f, 2.7461953f), new(0.1139511f, 0.1934149f, 0.6047450f)) },
            { "CuO", (new(3.2406201f, 2.4426033f, 2.2055559f), new(0.5199909f, 0.5688221f, 0.7206395f)) },
            { "CuO_palik", (new(3.2406201f, 2.4426033f, 2.2055559f), new(0.5199909f, 0.5688221f, 0.7206395f)) },
            { "Cu_palik", (new(0.2122105f, 0.9180478f, 1.1000715f), new(3.9132357f, 2.4519274f, 2.1321275f)) },
            { "d-C", (new(2.9000809f, 2.2932200f, 2.2227526f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "d-C_palik", (new(2.9000809f, 2.2932200f, 2.2227526f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "Hg", (new(2.3938384f, 1.4369678f, 0.9076226f), new(6.3141961f, 4.3626614f, 3.4145384f)) },
            { "HgTe", (new(4.7693987f, 3.2241340f, 2.6543894f), new(1.6285255f, 1.5774616f, 1.7259173f)) },
            { "HgTe_palik", (new(4.7693987f, 3.2241340f, 2.6543894f), new(1.6285255f, 1.5774616f, 1.7259173f)) },
            { "Hg_palik", (new(2.3938384f, 1.4369678f, 0.9076226f), new(6.3141961f, 4.3626614f, 3.4145384f)) },
            { "Ir", (new(3.0798657f, 2.0777743f, 1.6144552f), new(5.5802827f, 4.0585437f, 3.2603364f)) },
            { "Ir_palik", (new(3.0798657f, 2.0777743f, 1.6144552f), new(5.5802827f, 4.0585437f, 3.2603364f)) },
            { "K", (new(0.0639137f, 0.0463116f, 0.0381033f), new(2.0997543f, 1.3460704f, 0.9112770f)) },
            { "KBr", (new(1.8710068f, 1.4797838f, 1.4339677f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "KBr_palik", (new(1.8710068f, 1.4797838f, 1.4339677f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "KCl", (new(1.7888609f, 1.4127049f, 1.3644712f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "KCl_palik", (new(1.7888609f, 1.4127049f, 1.3644712f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "K_palik", (new(0.0639137f, 0.0463116f, 0.0381033f), new(2.0997543f, 1.3460704f, 0.9112770f)) },
            { "Li", (new(0.2652515f, 0.1951913f, 0.2204497f), new(3.5330424f, 2.3061826f, 1.6650529f)) },
            { "Li_palik", (new(0.2652515f, 0.1951913f, 0.2204497f), new(3.5330424f, 2.3061826f, 1.6650529f)) },
            { "MgO", (new(2.0852160f, 1.6472099f, 1.5914952f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "MgO_palik", (new(2.0852160f, 1.6472099f, 1.5914952f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "Mo", (new(4.4741750f, 3.5179915f, 2.7701843f), new(4.1023879f, 3.4136178f, 3.1439271f)) },
            { "Mo_palik", (new(4.4741750f, 3.5179915f, 2.7701843f), new(4.1023879f, 3.4136178f, 3.1439271f)) },
            { "NaCl", (new(1.8531404f, 1.4640130f, 1.4150935f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "NaCl_palik", (new(1.8531404f, 1.4640130f, 1.4150935f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "Na_palik", (new(0.0601384f, 0.0560220f, 0.0618597f), new(3.1725416f, 2.1079972f, 1.5757470f)) },
            { "Nb", (new(3.4128728f, 2.7842777f, 2.3905044f), new(3.4340739f, 2.7318301f, 2.5744548f)) },
            { "Nb_palik", (new(3.4128728f, 2.7842777f, 2.3905044f), new(3.4340739f, 2.7318301f, 2.5744548f)) },
            { "Ni_palik", (new(2.3622499f, 1.6598258f, 1.4639456f), new(4.4892879f, 3.0436885f, 2.3404558f)) },
            { "Rh", (new(2.5803103f, 1.8562348f, 1.5511398f), new(6.7678862f, 4.6929655f, 3.9676633f)) },
            { "Rh_palik", (new(2.5803103f, 1.8562348f, 1.5511398f), new(6.7678862f, 4.6929655f, 3.9676633f)) },
            { "Se-e", (new(5.7520843f, 4.1521964f, 4.0728436f), new(0.8697530f, 1.1029030f, 1.5615500f)) },
            { "Se-e_palik", (new(5.7520843f, 4.1521964f, 4.0728436f), new(0.8697530f, 1.1029030f, 1.5615500f)) },
            { "Se", (new(4.0803776f, 2.8334236f, 2.8145790f), new(0.7537781f, 0.6370541f, 0.5204686f)) },
            { "Se_palik", (new(4.0803776f, 2.8334236f, 2.8145790f), new(0.7537781f, 0.6370541f, 0.5204686f)) },
            { "SiC", (new(3.1656137f, 2.5206044f, 2.4741082f), new(0.0000008f, -0.0000007f, 0.0000094f)) },
            { "SiC_palik", (new(3.1656137f, 2.5206044f, 2.4741082f), new(0.0000008f, -0.0000007f, 0.0000094f)) },
            { "SiO", (new(2.3598175f, 1.8961871f, 1.8942370f), new(0.0118286f, 0.0238433f, 0.0780569f)) },
            { "SnTe", (new(4.5156274f, 1.9769149f, 1.2789698f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "SnTe_palik", (new(4.5156274f, 1.9769149f, 1.2789698f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "Ta", (new(2.0582008f, 2.3880184f, 2.6225028f), new(2.4029300f, 1.7376680f, 1.9429121f)) },
            { "Ta_palik", (new(2.0582008f, 2.3880184f, 2.6225028f), new(2.4029300f, 1.7376680f, 1.9429121f)) },
            { "Te-e", (new(7.4927454f, 4.2873888f, 2.3648376f), new(5.5723619f, 4.9371381f, 3.9890409f)) },
            { "Te-e_palik", (new(7.4927454f, 4.2873888f, 2.3648376f), new(5.5723619f, 4.9371381f, 3.9890409f)) },
            { "Te", (new(7.3751998f, 4.4725628f, 2.6314917f), new(3.2491925f, 3.5199149f, 3.2852094f)) },
            { "Te_palik", (new(7.3751998f, 4.4725628f, 2.6314917f), new(3.2491925f, 3.5199149f, 3.2852094f)) },
            { "ThF4", (new(1.8268368f, 1.4391665f, 1.3847053f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "ThF4_palik", (new(1.8268368f, 1.4391665f, 1.3847053f), new(0.0000000f, 0.0000000f, 0.0000000f)) },
            { "TiC", (new(3.6926126f, 2.8314116f, 2.5768321f), new(3.2587650f, 2.3465648f, 2.1681809f)) },
            { "TiC_palik", (new(3.6926126f, 2.8314116f, 2.5768321f), new(3.2587650f, 2.3465648f, 2.1681809f)) },
            { "TiN", (new(1.6449747f, 1.1480001f, 1.3768548f), new(3.3613205f, 1.9393624f, 1.0996749f)) },
            { "TiN_palik", (new(1.6449747f, 1.1480001f, 1.3768548f), new(3.3613205f, 1.9393624f, 1.0996749f)) },
            { "TiO2-e", (new(3.0999689f, 2.5078166f, 2.5769072f), new(0.0000289f, -0.0000251f, 0.0001772f)) },
            { "TiO2-e_palik", (new(3.0999689f, 2.5078166f, 2.5769072f), new(0.0000289f, -0.0000251f, 0.0001772f)) },
            { "TiO2", (new(3.4492822f, 2.7957618f, 2.8989937f), new(0.0001024f, -0.0000895f, 0.0006337f)) },
            { "TiO2_palik", (new(3.4492822f, 2.7957618f, 2.8989937f), new(0.0001024f, -0.0000895f, 0.0006337f)) },
            { "VC", (new(3.6498051f, 2.7468834f, 2.5273166f), new(3.0618420f, 2.1940002f, 1.9590204f)) },
            { "VC_palik", (new(3.6498051f, 2.7468834f, 2.5273166f), new(3.0618420f, 2.1940002f, 1.9590204f)) },
            { "VN", (new(2.8595247f, 2.1146777f, 1.9359668f), new(3.0258965f, 2.0517404f, 1.6128668f)) },
            { "VN_palik", (new(2.8595247f, 2.1146777f, 1.9359668f), new(3.0258965f, 2.0517404f, 1.6128668f)) },
            { "V_palik", (new(4.2684307f, 3.5057018f, 2.7552776f), new(3.4837670f, 2.8832176f, 3.1051085f)) },
            { "W", (new(4.3614259f, 3.2932937f, 2.9919083f), new(3.4932466f, 2.5993342f, 2.2683773f)) },
        };

        public static void SetMetalEtaQueryDict(string path)
        {
            List<(string, Color3F, Color3F)> res = new List<(string, Color3F, Color3F)>();
            //string path = @"D:\ProjectCpp\pbrt-v3-scenes\spds\metals";
            foreach (var fileName in Directory.EnumerateFiles(path))
            {
                if (fileName.Contains(".eta."))
                {
                    string name = Path.GetFileNameWithoutExtension(fileName);
                    int idx = name.IndexOf(".eta");
                    //Console.WriteLine($"{name} {name.IndexOf(".eta")}");
                    ...
                    {
                        string eta = Path.Combine(path, $"{realName}.eta.spd");
                        using var file = File.OpenRead(eta);
                        ...
                        while (!reader.EndOfStream)
                        {
                            ...
                            float lv = float.Parse(line.AsSpan()[0..split]);
                            float nv = float.Parse(line.AsSpan()[(split + 1)..(^1)]);
                            lambda.Add(lv);
                            n.Add(nv);
                        }
                    }
                    {
                        string kPath = Path.Combine(path, $"{realName}.k.spd");
                        using var file = File.OpenRead(kPath);
                        using var reader = new StreamReader(file);
                        while (!reader.EndOfStream)
                        {
                            string line = reader.ReadLine()!;
                            ...
                            int split = line.IndexOf(' ');
                            float lv = float.Parse(line.AsSpan()[0..split]);
                            float kv = float.Parse(line.AsSpan()[(split + 1)..(^1)]);
                            if (lambda[k.Count] != lv)
                            {
                                Console.WriteLine("??");
                            }
                            k.Add(kv);
                    ...
                    float[] lmbdaArr = lambda.ToArray();
                    float[] nArr = n.ToArray();
                    float[] kArr = k.ToArray();
                    Color3F etaCoeff = FromSampled(lmbdaArr, nArr);
                    Color3F kCoeff = FromSampled(lmbdaArr, kArr);
                    res.Add((realName, etaCoeff, kCoeff));
                    Console.WriteLine($"{realName} {etaCoeff} {kCoeff}");
                }
            }
            //StringBuilder sb = new StringBuilder();
            //sb.AppendLine("namespace Radiantium.Offline");
            //sb.AppendLine("{");
            //sb.AppendLine("    public partial class SpectrumQuery");
            //sb.AppendLine("    {");
            //sb.AppendLine("        public static Dictionary<string, (Color3F, Color3F)> NameToEtaK = new()");
            //sb.AppendLine("        {");
            //foreach (var i in res)
            //{
            //    var (name, eta, k) = i;
            //    sb.AppendLine($"            {{\"{name}\",(new({eta.R:F7}f,{eta.G:F7}f,{eta.B:F7}f),new({k.R:F7}f,{k.G:F7}f,{k.B:F7}f))}},");
            //}
            //sb.AppendLine("        };");
            //sb.AppendLine("    }");
            //sb.AppendLine("}");
            ...
            _nameToEtaK = res.ToDictionary(r => r.Item1, r => (r.Item2, r.Item3));
        }

        private static float InterpolateSpectrumSamples(float[] lambda, float[] vals, float l)
        {
            int n = lambda.Length;
            if (l <= lambda[0]) return vals[0];
            if (l >= lambda[n - 1]) return vals[n - 1];
            int offset = MathExt.FindInterval(lambda, l, (tar, now) => now <= tar);
            float t = (l - lambda[offset]) / (lambda[offset + 1] - lambda[offset]);
            return MathExt.Lerp(t, vals[offset], vals[offset + 1]);
        }

        private static bool SpectrumSamplesSorted(float[] lambda, float[] vals)
        {
            int n = lambda.Length;
            for (int i = 0; i < n - 1; ++i)
        ...
        private static void SortSpectrumSamples(float[] lambda, float[] vals)
        {
            int n = lambda.Length;
            (float, float)[] sortVec = new (float, float)[n];
            for (int i = 0; i < n; ++i)
            {
                sortVec[i] = (lambda[i], vals[i]);
            }
            Array.Sort(sortVec, Comparer<(float, float)>.Create((l, r) => Comparer<float>.Default.Compare(l.Item1, r.Item1)));
            for (int i = 0; i < n; ++i)
            {
        ...
        private static float[] CIE_lambda = new float[]{
